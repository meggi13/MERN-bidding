This is a application build using MERN stack. The application allows farmers to communicate with consumer directly and sell their product through the process of bidding.
In backend,
